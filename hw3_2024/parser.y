...
%type<charv>  while_stmt do_while_stmt while_tag do_tag 
%type<charv>  switch_stmt switch_clause switch_content case_expr
%type<charv>  default_expr factor if_else_stmt break_stmt
%type<charv>  ident var_init scalar_decl func_decl program
%type<charv>  array_decl func_def var_decl ident_tail
%type<charv>  expr_stmt compound_stmt_content stmt condition 
%type<charv>  if_stmt else_stmt for_stmt arglist args 
%type<charv>  for_condition for_content for_layer_2 expr 
%type<charv>  arr_ident arr_tag arr_content box arr_cnt_fmt arr_id
%type<charv>  type_ident parameter_info parameters compound_stmt 
%type<charv>  section init continue_stmt return_stmt arr_ident_init
...
switch_clause: '{' switch_content '}'               {   $$ = reduce_scope($1, $2, $3);   }
...
compound_stmt: '{' compound_stmt_content '}'        {   $$ = reduce_scope($1, $2, $3);    }
...
arr_cnt_fmt: '{' arr_content '}'                    {   $$ = reduce_scope($1, $2, $3);    }
